...
class TestParabolicCurve(unittest.TestCase):
	...
	def test_different_axes_no_intersections(self):
		curve1 = ParabolicCurve((4000, 8000), (4500, 5000), (1000, 6000))
		curve2 = ParabolicCurve((1000, 3000), (4000, 9000), (6000, 2000))
	...
	def test_different_axes_one_intersection_2(self):
		curve1 = ParabolicCurve((1000, 4000), (8000, 11000), (7000, 4000))
		curve2 = ParabolicCurve((8000, 5000), (2000, 10000), (7000, 3000))
	...
	def test_different_axes_two_intersections_2(self):
		curve1 = ParabolicCurve((1000, 6000), (4000, 5000), (2000, 3000))
		curve2 = ParabolicCurve((4000, 8000), (1000, 3000), (5000, 4000))

		self.assert_intersections(curve1, curve2, (2714, 4842), (2797, 4360))

	def test_different_axes_two_intersections_3(self):
		curve1 = ParabolicCurve((1000, 5500), (8500, 4500), (1000, 3000))
		curve2 = ParabolicCurve((1000, 7000), (1500, 1000), (3000, 3000))

		self.assert_intersections(curve1, curve2, (1159, 5478), (1684, 3143))

	def test_different_axes_three_intersections_1(self):
		curve1 = ParabolicCurve((1000, 4000), (8000, 3000), (3000, 2000))
		curve2 = ParabolicCurve((2000, 1000), (3000, 9000), (4000,    0))
	...
	def test_different_axes_four_intersections_2(self):
		curve1 = ParabolicCurve((2000, 4000), (9000, 1000), (1000, 7000))
		curve2 = ParabolicCurve((1000, 3000), (9000, 9000), (1000, 2000))
	...
	def test_vertical_axes_no_intersections_1(self):
		curve1 = ParabolicCurve((1000, 1000), (3000, 4000), (5000, 2000))
		curve2 = ParabolicCurve((3000, 5000), (2000,    0), (1000, 6000))

		self.assert_intersections(curve1, curve2)

	def test_vertical_axes_no_intersections_2(self):
		curve1 = ParabolicCurve((3000, 4000), (4000, 2000), (5000, 4000))
		curve2 = ParabolicCurve((7000, 4000), (4000, 5000), (1000, 4000))

		self.assert_intersections(curve1, curve2)

	def test_vertical_axes_one_intersection_1(self):
		curve1 = ParabolicCurve((1000, 4000), (2000, 2000), (3000, 5000))
		curve2 = ParabolicCurve((4000, 6000), (3000, 3000), (2000, 5000))

		self.assert_intersections(curve1, curve2, (2700, 4212))

	def test_vertical_axes_one_intersection_2(self):
		curve1 = ParabolicCurve((1000, 3000), (2000, 2000), (3000, 3000))
		curve2 = ParabolicCurve((2000, 1000), (3000, 5000), (4000, 2000))

		self.assert_intersections(curve1, curve2, (2538, 2644))

	def test_vertical_axes_two_intersections_1(self):
		curve1 = ParabolicCurve((5000, 4000), (3000, 3000), (1000, 6000))
		curve2 = ParabolicCurve((4000, 5000), (3000, 1000), (2000, 7000))

		self.assert_intersections(curve1, curve2, (2626, 4222), (3595, 3791))

	def test_vertical_axes_two_intersections_2(self):
		curve1 = ParabolicCurve((5000, 1000), (3500, 3500), (2000, 2500))
		curve2 = ParabolicCurve((5000, 2500), (4000, 1000), (3000, 3500))

		self.assert_intersections(curve1, curve2, (3391, 2675), (4329, 1944))

	def test_parallel_axes_no_intersections_1(self):
		curve1 = ParabolicCurve((2500, 2500), (3000, 1000), (4500, 1500))
		curve2 = ParabolicCurve((1000, 2000), (2500, 2500), (3000, 1000))

		self.assert_intersections(curve1, curve2)

	def test_parallel_axes_no_intersections_2(self):
		curve1 = ParabolicCurve((2500, 2000), (4000, 2500), (4500, 1000))
		curve2 = ParabolicCurve((1000, 2000), (2500, 2500), (3000, 1000))

		self.assert_intersections(curve1, curve2)

	def test_parallel_axes_one_intersection_1(self):
		curve1 = ParabolicCurve((3500, 3500), (1000, 1000), (4500, 1500))
		curve2 = ParabolicCurve((2000, 4000), (1500, 2500), (3000, 2000))

		self.assert_intersections(curve1, curve2, (2518, 2217))

	def test_parallel_axes_one_intersection_2(self):
		curve1 = ParabolicCurve((2000, 2500), (3000, 3500), (1500, 4500))
		curve2 = ParabolicCurve((1000, 2500), (2500, 4000), (1000, 5500))

		self.assert_intersections(curve1, curve2, (1709, 4352))

	def test_parallel_axes_two_intersections_1(self):
		curve1 = ParabolicCurve((1000, 2500), (3500, 2500), (3500, 5000))
		curve2 = ParabolicCurve((1500, 3000), (4000, 1500), (2500, 4000))

		self.assert_intersections(curve1, curve2, (2113, 2663), (2930, 3183))

	def test_parallel_axes_two_intersections_2(self):
		curve1 = ParabolicCurve((2000, 2500), (2500, 1000), (4000, 1500))
		curve2 = ParabolicCurve((3000, 1000), (2500, 2500), (1000, 2000))
